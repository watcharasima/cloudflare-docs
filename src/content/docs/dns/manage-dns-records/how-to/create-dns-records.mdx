...
Refer to the sections below for step-by-step instructions on managing DNS records at Cloudflare.

To better understand what DNS records are, refer to [Overview](/dns/manage-dns-records/). For context around common records you want to review when getting started at Cloudflare, refer to [Initial setup](/dns/manage-dns-records/how-to/initial-setup/).
