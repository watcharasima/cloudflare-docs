...
* `env` object
  ...
  * An object containing the bindings associated with your Worker using [ES modules format](/workers/reference/migrate-to-module-workers/), such as Workers KV namespaces and Durable Objects.
