...
* Improved error message when a single request performs more than 1000 key-value operations to make clear that a per-request limit was reached, not a global rate limit.
