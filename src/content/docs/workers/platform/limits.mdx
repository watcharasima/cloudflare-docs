...
A subrequest is any request that a Worker makes to either Internet resources using the [Fetch API](/workers/runtime-apis/fetch/) or requests to other Cloudflare services like [R2](/r2/), [Workers KV](/kv/), or [D1](/d1/).
...
- [Workers KV limits](/kv/platform/limits/)
