...
In addition to testing Workers locally with [`wrangler dev`](/workers/wrangler/commands/#dev), the use of Miniflare allows you to test other Developer Platform products locally, such as [R2](/r2/), [Workers KV](/kv/), [D1](/d1/), and [Durable Objects](/durable-objects/).
...
When running `wrangler dev`, resources such as Workers KV, Durable Objects, D1, and R2 will be stored and persisted locally and not affect the production resources.
