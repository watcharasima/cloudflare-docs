...
Bindings allow your Workers to interact with resources on the Cloudflare developer platform, including [R2](/r2/), [Workers KV](/kv/concepts/how-kv-works/), [Durable Objects](/durable-objects/), and [D1](/d1/).
