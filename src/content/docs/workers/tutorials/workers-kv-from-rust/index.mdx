...
In the terminal, use Wrangler to create a Workers KV namespace for `cities`. This generates a configuration to be added to the project:
...
With this configured, you can access the Workers KV namespace with the binding `"cities"` from Rust.
