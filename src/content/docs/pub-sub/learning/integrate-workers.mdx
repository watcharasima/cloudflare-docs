...
1. **As an “On Publish” hook that receives all messages published to a Broker**. This allows the Worker to modify, copy to other destinations (such as [R2](/r2/) or [Workers KV](/kv/concepts/how-kv-works/)), filter and/or drop messages before they are delivered to subscribers.
